...
namespace Crosstales.OnlineCheck.Util
{
   ...
   public static class NetworkInfo
   {
      ...
      private static System.Collections.Generic.List<Model.NetworkInterface> interfaceCache;
      ...
      public static System.Collections.Generic.List<Model.NetworkInterface> LastNetworkInterfaces
      {
         get
         {
#if (!UNITY_WEBGL && !UNITY_WSA && !UNITY_XBOXONE) || UNITY_EDITOR
      ...
      public static System.Collections.Generic.List<Model.NetworkInterface> getNetworkInterfaces(bool activeOnly = true)
      {
         System.Collections.Generic.List<Model.NetworkInterface> interfaces = new System.Collections.Generic.List<Model.NetworkInterface>();
      ...
      public static bool isPlatformSupported => !Util.Helper.isWebPlatform && !Util.Helper.isWSABasedPlatform;
