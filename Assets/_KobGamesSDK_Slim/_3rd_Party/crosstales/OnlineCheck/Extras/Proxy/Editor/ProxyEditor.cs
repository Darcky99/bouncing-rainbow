      ...
      public override void OnInspectorGUI()
      {
         ...
         if (script.isActiveAndEnabled)
         {
            if (Util.Helper.isEditorMode)
            {
               ...
               {
                  if (GUILayout.Button(new GUIContent(" Disable", EditorUtil.EditorHelper.Icon_Minus, "Disable HTTP-Proxy.")))
                  {
               ...
               {
                  if (GUILayout.Button(new GUIContent(" Enable", EditorUtil.EditorHelper.Icon_Plus, "Enable HTTP-Proxy.")))
                  {
               ...
               {
                  if (GUILayout.Button(new GUIContent(" Disable", EditorUtil.EditorHelper.Icon_Minus, "Disable HTTPS-Proxy.")))
                  {
               ...
               {
                  if (GUILayout.Button(new GUIContent(" Enable", EditorUtil.EditorHelper.Icon_Plus, "Enable HTTPS-Proxy.")))
                  {
