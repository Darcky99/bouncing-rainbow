...
public class AppMetrica : MonoBehaviour
{
    ...
    public string _ApiKey { get { return ApiKey; } set { ApiKey = value; } }

    [SerializeField] private bool ExceptionsReporting = true;

    [SerializeField] private uint SessionTimeoutSec = 10;
    public uint _SessionTimeoutSec { get { return SessionTimeoutSec; } set { SessionTimeoutSec = value; } }

    [SerializeField] private bool LocationTracking = false;
    public bool _LocationTracking { get { return LocationTracking; } set { LocationTracking = value; } }
