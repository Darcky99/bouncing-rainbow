...
namespace OmniSARTechnologies.LiteFPSCounter {
    ...
    public class LiteFPSCounterEditor : Editor {
        ...
        private SerializedProperty m_DynamicInfoTextMeshPro = null;
        ...
        private void OnEnable() {
            ...
            m_DynamicInfoTextMeshPro = serializedObject.FindProperty("dynamicInfoTextMeshPro");
        ...
        private void DrawUIOptions<T>(SerializedProperty headerProperty) {
            ...
            EditorGUIHelper.Drawing.DrawMultiValueObjectField<T>(m_DynamicInfoTextMeshPro);
