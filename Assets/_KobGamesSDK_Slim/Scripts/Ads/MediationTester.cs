...
public class MediationTester : MonoBehaviour
{
    private string MaxSdkKey                    => GameSettings.Instance.AdsMediation.MAXSDKKey;
    private string InterstitialAdUnitId         => GameSettings.Instance.AdsMediation.MAXInterstitialAdUnitIdAndroid;
    private string RewardedAdUnitId             => GameSettings.Instance.AdsMediation.MAXRewardVideoAdUnitIdAndroid;
    private string RewardedInterstitialAdUnitId => "RewardedInterstitialAdUnitId";
    private string BannerAdUnitId               => GameSettings.Instance.AdsMediation.MAXBannerAdUnitIdAndroid;
    ...
    {
        ToggleButton = transform.FindDeepChild<Button>("Toggle Button");
        Screen       = transform.FindDeepChild<GameObject>("Screen");

        showInterstitialButton         = transform.FindDeepChild<Button>("ShowInterstitialButton");
        showRewardedButton             = transform.FindDeepChild<Button>("ShowRewardedButton");
        showRewardedInterstitialButton = transform.FindDeepChild<Button>("ShowRewardedInterButton");
        showBannerButton               = transform.FindDeepChild<Button>("ShowBannerButton");
        showMRecButton                 = transform.FindDeepChild<Button>("ShowMRecButton");
        mediationDebuggerButton        = transform.FindDeepChild<Button>("MediationDebuggerButton");

        interstitialStatusText         = transform.FindDeepChild<TextMeshProUGUI>("InterstitialStatusText");
        rewardedStatusText             = transform.FindDeepChild<TextMeshProUGUI>("RewardedStatusText");
        rewardedInterstitialStatusText = transform.FindDeepChild<TextMeshProUGUI>("RewardedInterStatusText");
    }
