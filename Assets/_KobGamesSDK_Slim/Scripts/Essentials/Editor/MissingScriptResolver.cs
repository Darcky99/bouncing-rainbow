...
This component's properties are shown below to help you determine which script is correct.";
    ...
    [MenuItem("KobGamesSDK/Find Missing Scripts In Prefabs", priority = 1)]
    ...
    [MenuItem("KobGamesSDK/Find Missing Scripts In Scene", priority = 0)]
...
#else
                Undo.RegisterCreatedObjectUndo(target, "Assign missing script");
#endif
