...
public class FindMissingScriptsRecursively : EditorWindow
{
    ...
    [MenuItem("KobGamesSDK/Find Missing Scripts Recursively", priority = 2)]
...
public static class FindMissingScriptsRecursivelyAndRemove
{
    ...
    private static void FindAndRemoveMissingInSelected()
    {
        ...
        KobGamesSDKSlim.ExtensionMethods.FindAndRemoveMissingScriptsInSelected(deeperSelection.ToArray());
    }
}